...
| **September 22** | 10:00-16:00 (likely shorter) |Segerfalksalen|  Examination part 1 *(for 1.5 and 6 ECTS version)* |
...
The students will plan a small AI-related project of their choice with a step-wise [project notebook](colab_notebooks/Project_Template.ipynb) that aligns with the course content and explore how much of it can be realized within a short time with AI support. Examination 1 will consist of a presentation of the project and oral questioning by other course participants and the course leader. Every student will be the main questioner for another student project in addition to presenting their own project, and both presentation and questioning (for asking and answering) are part of the examination. 
...
- All AI used in the project, including any chatbots you have used. You have to use at least two types of AI. For examination 1, it is sufficient if one of them is a chatbot you used to support you in your project work and the second is the AI you planned/developed. For examination 2, it is sufficient if you trained two different models or explored two different architectures.
...
# Note on recordings
The lectures of the course will be recorded. If you wish, recordings can be paused during questions. Simply send an email to the course leader if your questions are not to be recorded or mention it during the course if you would like the recording to be paused. Comments or questions can also be removed afterwards if you forgot at the time or changed your mind, no reason required. The debate and examinations will not be recorded. Recordings cannot be made available during the course, but perhaps at a later point. Their main purpose is to improve the course for the next iteration.
